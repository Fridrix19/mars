/* Marscap — пресет PrimeVue 4 (styled mode) из токенов дизайн-системы.
   В Nuxt: export default definePreset(Aura, MARSCAP_PRESET) — объект тот же. */
window.MARSCAP_PRESET = {
  primitive: {
